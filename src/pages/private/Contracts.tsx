                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between text-xs">
                        ...
                        <div
                          className={`badge badge-outline ${contractBadgeMapped(contract.status)}`}
                        >
                ...
                <div className="p-8 flex-1 flex flex-col justify-between">
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                      ...
                      <p className="font-black text-emerald-700">R$ {contract.plan.cost}</p>
                    </div>
                    <div>
                      <p className="text-[10px] text-slate-400 font-bold uppercase mb-1 tracking-widest">
                        Apólice Nº
                  ...
                  <div className="w-full">
                    <Button className="w-full">Visulizar</Button>
                  </div>
                </div>
              </div>
            </div>
