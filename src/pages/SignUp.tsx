      ...
      {[1, 2, 3].map((s) => (
        <React.Fragment key={s}>
          <div className="flex flex-col items-center">
            ...
            <span
              className={`text-[10px] mt-2 font-bold uppercase tracking-tighter ${step >= s ? "text-emerald-700" : "text-slate-400"}`}
            >
              ...
              <div className="space-y-6 animate-in slide-in-from-right-8 duration-500">
                <div className="text-center mb-4">
                  ...
                  <p className="text-slate-500 text-sm">
                    Insira seus dados para começar a proteção.
                  </p>
                </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          petSpecies: e.target.value as PetSpecies,
                          petBreed: "",
                        })
                      }
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-bold text-emerald-950 leading-none">
                        Beneficiário: {formData.petName || "Seu Pet"}
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="p-6 bg-slate-50 rounded-[2.5rem] border border-slate-100 space-y-4">
                      <div className="space-y-3">
                        <label className="text-xs font-bold text-slate-600 uppercase flex items-center gap-2 px-1">
                          <Calendar size={14} className="text-emerald-600" /> Escolha o dia de
                          vencimento
                        </label>
                        ...
                        <div className="bg-amber-50 p-4 rounded-2xl border border-amber-200 flex gap-3 text-amber-800 animate-in zoom-in-95 duration-300">
                          ...
                          <div>
                            ...
                            <p className="text-[10px] leading-relaxed font-medium">
                              Datas de vencimento após o <strong>dia 15</strong> podem gerar duas
                              faturas no primeiro mês devido ao tempo de compensação bancária e
                              fechamento de ciclo.
                            </p>
                          </div>
                        </div>
                  ...
                  <div className="p-6 bg-blue-50 rounded-[2.5rem] border border-blue-100 flex gap-4 animate-in fade-in duration-500">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-[11px] text-blue-700 leading-relaxed">
                        A cobrança será automática no seu cartão. Os dados de pagamento serão
                        solicitados com segurança após o acesso inicial ao painel.
                      </p>
                    </div>
                  </div>
                )}
            ...
            <div className="flex gap-4 pt-4">
              ...
              {step < 3 ? (
                <button
                  ...
                  disabled={
                    (step === 1 &&
                      (!formData.name || !formData.email || !formData.cpf || !formData.password)) ||
                    (step === 2 &&
                      (!formData.petName || !formData.petBreed || !formData.petBirthDate))
                  }
        ...
        <div className="mt-8 text-center space-y-6">
          ...
          <div className="pt-6 border-t border-slate-200">
            <p className="text-sm text-slate-600">
              ...
              <Link
                to="/login"
                className="text-emerald-600 font-black hover:underline tracking-tight ml-1"
              >
                FAZER LOGIN
              </Link>
            </p>
