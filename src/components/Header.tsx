      ...
      <div className="relative" ref={menuRef}>
        ...
        >
          <div className="hidden sm:block text-right pr-2 border-r border-slate-200">
            <p className="text-xs font-bold text-slate-800 leading-tight">Ricardo Oliveira</p>
            <p className="text-[10px] text-emerald-600 font-medium leading-tight">Plano Gold</p>
          </div>
        ...
        {isMenuOpen && (
          <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-xl border border-slate-100 py-2 z-50 animate-in fade-in zoom-in-95 duration-100">
            <div className="px-4 py-3 border-b border-slate-50 mb-1">
              <p className="text-sm font-bold text-slate-800">Ricardo Oliveira</p>
              <p className="text-xs text-slate-500">ricardo.oliveira@email.com</p>
            </div>
