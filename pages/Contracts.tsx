  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="mb-8">
        ...
        <p className="text-slate-500 text-sm">Cada pet possui seu próprio plano e condições específicas.</p>
      </div>
              ...
              <div className="flex flex-col md:flex-row">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center space-x-4">
                      <div className="relative">
                        <img src={pet?.photo} className="w-16 h-16 rounded-2xl object-cover ring-4 ring-white shadow-sm" />
                      ...
                      <div>
                        ...
                        <p className="text-xs font-bold text-emerald-600 uppercase tracking-tighter">{contract.planName}</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between text-xs">
                        ...
                        <div className="flex items-center gap-1 text-slate-700 font-bold">
                          {contract.paymentMethod === 'Cartão' ? <CreditCard size={12} /> : <QrCode size={12} />}
                ...
                <div className="p-8 flex-1">
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
                    <div>
                      <p className="text-[10px] text-slate-400 font-bold uppercase mb-1 tracking-widest">Ativo desde</p>
                      <p className="font-bold text-slate-700">{new Date(contract.startDate).toLocaleDateString('pt-BR')}</p>
                    </div>
                    <div>
                      <p className="text-[10px] text-slate-400 font-bold uppercase mb-1 tracking-widest">Renovação</p>
                      <p className="font-bold text-slate-700">{new Date(contract.renewalDate).toLocaleDateString('pt-BR')}</p>
                    </div>
                    <div>
                      <p className="text-[10px] text-slate-400 font-bold uppercase mb-1 tracking-widest">Valor Mensal</p>
                      <p className="font-black text-emerald-700">R$ {contract.monthlyValue.toFixed(2)}</p>
                    </div>
                    <div>
